    ...
    <Horizontal>
      <Vertical style={{flex:'1',background:'lightgray'}}>
        <div style={{display:'flex',padding:'10px 0 10px 20px',justifyContent:'space-between',flexDirection:'row',background:'rgb(94,100,179)',color:'white',textAlign:'center',fontSize:'24px'}}>
          COVID-19 Controls Dashboard Detail
        </div>
        ...
        <div className="ag-theme-alpine" style={ { height: '90%', width: '100%' } }>
            <AgGridReact
                rowData={rowData}
            >
              <AgGridColumn field="id" sortable="true" filter="true" width="70px"></AgGridColumn>
              <AgGridColumn field="email" sortable="true" filter="true" width="250px"></AgGridColumn>
              <AgGridColumn field="authcode" sortable="true" filter="true" width="115px"></AgGridColumn>
              <AgGridColumn field="dateofvisit" sortable="true" filter="true" width="150px"></AgGridColumn>
              ...
              <AgGridColumn field="sessionid" sortable="true" filter="true"></AgGridColumn>
              ...
              <AgGridColumn field="comfortable" sortable="true" filter="true"></AgGridColumn>
              ...
              <AgGridColumn field="aloneorpeople" sortable="true" filter="true"></AgGridColumn>
              <AgGridColumn field="numpeople" sortable="true" filter="true"></AgGridColumn>
              <AgGridColumn field="contactsworkedwith" sortable="true" filter="true"></AgGridColumn>
              <AgGridColumn field="safetymet" sortable="true" filter="true"></AgGridColumn>
              <AgGridColumn field="addressnoncompliance" sortable="true" filter="true"></AgGridColumn>
              <AgGridColumn field="correctnoncompliance" sortable="true" filter="true"></AgGridColumn>
            </AgGridReact>
        </div>
      </Vertical>
      <Splitter/>
