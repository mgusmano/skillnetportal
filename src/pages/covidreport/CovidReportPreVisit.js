  ...
  const [comfortablechart, setComfortablechart] = useState(null)
    ...
    useEffect(() => {
      ...
      .then((response) => {
        ...
        setSocialdistancing(response.data.percentsocialdistancing)
        setFacecoverings(response.data.percentfacecoverings)
        setTracingplan(response.data.percenttracingplan)
        setHealthsafetyplan(response.data.percenthealthsafetyplan)
        setEmployeehealth(response.data.percentemployeehealth)
        setVisitorhealth(response.data.percentvisitorhealth)
        setOther(response.data.percentother)
