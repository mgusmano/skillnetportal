...
{percents !== null &&
<DropDown multiple={false} who="Date Range" onChanged={(event,checked) => filterChanged(checked,'percents')} options={percents} name="PercentName"/>
}

{percents !== null &&
<DropDown multiple={false} who="Division" onChanged={(event,checked) => filterChanged(checked,'percents')} options={percents} name="PercentName"/>
}

{percents !== null &&
<DropDown multiple={false} who="Country" onChanged={(event,checked) => filterChanged(checked,'percents')} options={percents} name="PercentName"/>
}
