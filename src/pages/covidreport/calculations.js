(function(exports){
  ...
  exports.WorkWithCountsCalculations = function(allArray) {
    var oResult = {
      ...
      workedwith4to10: 0,
      workedwith11to25: 0,
      workedwithmorethan25: 0
    }
    allArray.forEach(o => {
      var x = o['numworkedwith']
      switch(true){
        case (x === ''):
          break
        case (x === 0):
          ...
          break
        case (x < 4):
          oResult['workedwith1to3']++
          break
        case (x < 11):
          oResult['workedwith4to10']++
          break
        case (x < 26):
          oResult['workedwith11to25']++
          break
        default:
          oResult['workedwithmorethan25']++
          break
      }
    })
    return oResult
  ...
  exports.DateOfVisitsCalculations = function(allArray) {
    var daysArray = []
    allArray.forEach(o => {
  ...
  exports.CorrectionsCalculations = function(allArray) {
    ...
    var percentrescheduledvisit = ((totaldidnotgointoarea/num_responses)*100).toFixed(precision)
