...
{divisions !== null &&
<DropDown multiple={false} who="Division" onChanged={(event,checked) => filterChanged(checked,'percents')} options={divisions} name="PercentName"/>
}

{countries !== null &&
<DropDown multiple={false} who="Country" onChanged={(event,checked) => filterChanged(checked,'percents')} options={countries} name="PercentName"/>
}
